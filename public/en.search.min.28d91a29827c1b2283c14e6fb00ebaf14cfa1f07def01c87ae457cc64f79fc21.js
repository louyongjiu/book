...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.d5ddf903b3cc5a3609f43517ed31a2738a73bdf2d71a6017ccda3cbfd3d99adb.js',function(){input.required=false;search();});}
